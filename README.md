...
valgrind --tool=callgrind --callgrind-out-file=pytest/perf/Abdusattorov_Nodirbek.callgrind.out.%p ./build/gcc-make-RelWithDebInfo/pgn_parser pytest/perf/Abdusattorov_Nodirbek.pgn


valgrind --tool=callgrind --callgrind-out-file=pytest/perf/Abdusattorov_Yakubboev.callgrind.out.%p ./build/gcc-make-RelWithDebInfo/pgn_parser pytest/perf/Abdusattorov_Yakubboev.pgn
